...
<head>
    ...
    <title>VinculaCRM - Cadastro</title>
...
<body class="bg-primary">
    ...
    <form method="post" action="../controllers/cadastroAdm.php" class="container bg-light p-3 mt-5 rounded">
        ...
        <div class="input-group w-75 mx-auto my-3">
            <input class="form-control" type="password" name="passwordC" id="passwordC" placeholder="Confirme sua senha...">
        </div>
        <div class="d-flex w-75 mx-auto my-3 justify-content-around">
            <button class="d-block mx-2 btn btn-outline-primary w-50" type="submit">Cadastrar</button>
            <a class="d-block mx-2 btn btn-outline-primary w-50" href="../index.php">Voltar</a>
        </div>
    </form>
